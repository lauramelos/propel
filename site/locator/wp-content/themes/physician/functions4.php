...
<table width="516" align="center">
		...
		<div style="color:#9c9c9c; font-size:12px; font-family:Helvetica, Arial;line-height:18px">'.$nuevo['practice_name'][0].'<br />'.$nuevo['address'][0].' '.$nuevo['city'][0].', '.$nuevo['state'][0].' '.$nuevo['zip'][0].'</div><br/>
		...
		$result .='<br/> Email: &nbsp;<span style="color:#fcac00 !Important;">'.$nuevo['email_address'][0].'</span>';
		if ($nuevo['website'][0]<>'')
		$result .='<br/> Website:&nbsp;<span style="color:#fcac00 !Important;">'.$nuevo['website'][0].'</span>';
		...
		<tr >
		<td width="100" style="padding:0 30px;"><a href="http://67.222.18.91/~propel/locator/find-propel-physician/" style="color:#b4b4b1; font-size:12px; font-family:Arial, Helvetica, sans-serif; font-weight:600; text-decoration:none;"><img src="http://67.222.18.91/~propel/_img/mailfind.png" height="16" /> Find Propel</a></td>
  
  		<td width="100"><a href="http://67.222.18.91/~propel/co-contact_us.html" style="color:#b4b4b1; font-size:12px; font-family:Helvetica, Arial; font-weight:600; text-decoration:none;"> <img src="http://67.222.18.91/~propel/_img/mailcontact.png" /> Contact Us</a></td>
		...
		$result2='<p style="color:#9c9c9c; font-size:12px; font-family:Helvetica, Arial ; text-align:right;line-height:18px;">Distance: '.$distan_T[$a].'miles <br /><span style="color:#fcac00;">Directions</span></p>
  		</td>';
