...
function send_email($post) {
  ...
  if ($lat<>0)  
    ...
    $result .='<a href="http://maps.google.com?q='.$direc.'&z=15&markers=icon:'.$url.'/_img/content/map-marker2.png|'.$direc.'" target=_blank  style="text-decoration:none; border:none;" >
